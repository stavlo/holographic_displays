...
python main.py --epochs 300 --model amp_phs --z 0.01 && \
# chunk 1 z=0.05[m]
...
python main.py --epochs 300 --model amp_phs --z 0.05 && \
# chunk 1 z=0.1[m]
...
python main.py --epochs 300 --model amp_phs --z 0.1 && \
# chunk 1 z=0.25[m]
...
python main.py --epochs 300 --model amp_phs --z 0.25 && \
# chunk 1 z=0.5[m]
...
python main.py --epochs 300 --model amp_phs --z 0.5
# chunk 1 z=1.0[m]
...
python main.py --epochs 300 --model amp_phs --z 1.0
# chunk 1 z=1.5[m]
...
python main.py --epochs 300 --model amp_phs --z 1.5