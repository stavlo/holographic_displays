...
python main.py --epochs 200 --model skip_connection --z 1.0 && \
python main.py --epochs 200 --model conv --z 1.0
# chunk 1 z=1.5[m]
python main.py --model classic --z 1.5 && \
python main.py --epochs 200 --model skip_connection --z 1.5 && \
python main.py --epochs 200 --model conv --z 1.5